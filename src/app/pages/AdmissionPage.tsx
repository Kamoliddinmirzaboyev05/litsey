  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white dark:bg-gray-950 transition-colors duration-300">
      ...
      <section className="py-12 bg-white dark:bg-gray-950 transition-colors" data-aos="fade-up">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-[2rem] p-10 border border-blue-100 dark:border-blue-900/30 shadow-xl">
              <div className="flex items-start gap-6">
                <div className="w-14 h-14 bg-blue-500 rounded-2xl flex items-center justify-center text-white flex-shrink-0 shadow-lg">
                  <Clock size={28} />
                </div>
                <div>
              ...
              {steps.map((step, index) => {
                ...
                return (
                  <div 
                    ...
                    className="bg-white dark:bg-gray-950 rounded-3xl p-10 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-gray-800 group hover:-translate-y-2"
                  >
                    <div className="w-16 h-16 bg-[#0d89b1]/10 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-[#0d89b1] group-hover:text-white transition-all duration-500 transform group-hover:rotate-6 shadow-inner">
      ...
      <section className="py-20 bg-white dark:bg-gray-950 transition-colors">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              {testInfo.parts.map((part, index) => (
                <div 
                  ...
                  data-aos="fade-up"
                  data-aos-delay={index * 100}
                  className="bg-gray-50 dark:bg-gray-900 rounded-3xl p-10 border border-gray-100 dark:border-gray-800 shadow-lg hover:shadow-2xl transition-all duration-500 group"
                >
            ...
            <div className="bg-gradient-to-br from-[#0d89b1] to-[#0a6d8f] rounded-[3rem] p-12 text-white shadow-2xl relative overflow-hidden" data-aos="fade-up">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-4 mb-8">
                    {testInfo.availableDirections.map((dir, i) => (
                      <div key={i} className="bg-white text-[#0d89b1] px-8 py-4 rounded-2xl font-black text-lg shadow-xl uppercase tracking-widest">
                        {dir}
                      </div>
                    ))}
                  </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900 transition-colors">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-950 rounded-[3rem] p-12 shadow-2xl border border-gray-100 dark:border-gray-800" data-aos="fade-up">
              <div className="grid md:grid-cols-2 gap-8">
                {requirements.map((requirement, index) => (
                  <div key={index} className="flex items-center gap-6 p-6 bg-gray-50 dark:bg-gray-900 rounded-[2rem] hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all group">
                    <div className="w-14 h-14 bg-white dark:bg-gray-800 rounded-2xl flex items-center justify-center text-[#0d89b1] shadow-lg group-hover:bg-[#0d89b1] group-hover:text-white transition-all duration-500 transform group-hover:rotate-6">
                      <CheckCircle size={28} />
                    </div>
      ...
      <section className="py-24 bg-white dark:bg-gray-950 transition-colors">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-[#0d89b1] to-[#0a6d8f] rounded-[3rem] p-16 text-center text-white shadow-2xl relative overflow-hidden" data-aos="zoom-in">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap justify-center gap-8">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-4 px-12 py-6 bg-white/10 backdrop-blur-md text-white rounded-[2rem] hover:bg-white/20 transition-all font-black border border-white/30 hover:scale-105 uppercase tracking-[0.2em] text-sm"
                  >
                    <Clock size={28} />
                    +99873 241-33-07
                  </a>
